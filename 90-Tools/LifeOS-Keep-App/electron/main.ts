...
ipcMain.handle('note:getChildren', (_, id: string) => store.getChildren(id));
ipcMain.handle('note:getDescendants', (_, id: string) => store.getDescendants(id));
ipcMain.handle('note:getAncestors', (_, id: string) => store.getAncestors(id));
